...
Pebble.addEventListener('showConfiguration', function(e) {
  var html = '<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>ShotCounter Settings</title>' +
    ...
    '<div class="card">' +
    '<label>Recoil Sensitivity <span class="val" id="slider_val">50</span></label>' +
    ...
    '<script>' +
    'function save(){' +
    '  var sensVal = parseInt(document.getElementById("slider").value, 10);' +
...
Pebble.addEventListener('webviewclosed', function(e) {
  if (e && e.response) {
    try {
      ...
      if (dict.SENSITIVITY !== undefined) {
        payload[10000] = parseInt(dict.SENSITIVITY, 10);
      }
